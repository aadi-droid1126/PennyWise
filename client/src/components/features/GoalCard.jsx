  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${isComplete ? "#1a4a1a" : "var(--border)"}`,
        padding: "1.25rem",
        display: "flex",
    ...
    >
      ...
      <div>
        ...
        >
          <div
            style={{
              height: "100%",
              width: `${percent}%`,
              background: isComplete ? "#4caf50" : "var(--balloon-red)",
              borderRadius: "2px",
        ...
        >
          <span
            style={{
              fontFamily: "var(--font-mono)",
              fontSize: "0.65rem",
              color: isComplete ? "#4caf50" : "var(--dirty-white)",
            }}
          >
          ...
          <span
            style={{
              ...
              fontSize: "1rem",
              color: isComplete ? "#4caf50" : "var(--balloon-red)",
            }}
          >
            {percent}%
          </span>
        ...
        {!isComplete && (
          ...
          >
            {fmt(remaining)} remaining to escape
          </span>
        )}
      </div>
